...
import './ProjectPageTabletScreen.css';
import { Responsive } from 'semantic-ui-react';

function ProjectPageTabletScreen(props) {
  const obj = props.obj
  console.log('obj', obj)
  ...
  function mapIconeAndLogo(arr) {
    return arr.map((item, index) => {
      return (
        <div key={index} className="tablet-screen-project-page-link-item">
  ...
  function mapImagesAndLabels(arr) {
    return arr.map((item, index) => {
      return (
        <div className="tablet-screen-project-page-project-pictures" key={index}>
  ...
  return (
    <Responsive {...Responsive.onlyTablet}>
      <div className="tablet-screen-project-page-container">
        <div className="tablet-screen-project-page-title">
          <h1>{obj.title}</h1>
        </div>
        <div className="tablet-screen-project-page-main-img">
          <iframe 
          width="560" 
          height="315" 
...

        {
          (obj.frontEnd !== undefined) ? (
            <div className="tablet-screen-project-page-list">
            <h3>Front End</h3>
        ...
        <div className="tablet-screen-project-page-link-container">
        ...
        {
          (obj.imgs !== undefined) ? (
            <div className="tablet-screen-project-page-sample-imgs">
...
export default ProjectPageTabletScreen
