    ...
    <Responsive {...Responsive.onlyComputer}>
      <div className="computer-about-section-container">
        ...
        <div className="computer-about-section-bio">
          <p>Full-stack web developer with a passion for problem-solving and beautiful web design.</p>
          <p>In the past 2+ years, I helped manage over 4 E-commerce websites, worked on a team of <br />
          3+ developers, to build 4 full-stack web applications, and worked on 5 solo web and mobile <br /> app projects.</p>
        </div>
      </div>
    </Responsive>
  )
