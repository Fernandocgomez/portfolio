...
function ProjectPageMobileScreen(props) {
  ...
  function mapIconeAndLogo(arr) {
    return arr.map((item, index) => {
      return (
        <div key={index} className="mobile-screen-project-page-link-item">
  ...
  function mapImagesAndLabels(arr) {
    return arr.map((item, index) => {
      return (
        <div className="mobile-screen-project-page-project-pictures" key={index}>
  ...
  return (
    <Responsive {...Responsive.onlyMobile}>
      <div className="mobile-screen-project-page-container">
        <div className="mobile-screen-project-page-title">
          <h1>{obj.title}</h1>
        </div>
        <div className="mobile-screen-project-page-main-img">
          <iframe 
          width="560" 
          height="315" 
        ...
        <div className="mobile-screen-project-page-des">
          <p>{obj.des}</p>
...

        {
          (obj.frontEnd !== undefined) ? (
            <div className="mobile-screen-project-page-list">
            <h3>Front End</h3>
        ...
        <div className="mobile-screen-project-page-link-container">
        ...
        {
          (obj.imgs !== undefined) ? (
            <div className="mobile-screen-project-page-sample-imgs">
...
export default ProjectPageMobileScreen
