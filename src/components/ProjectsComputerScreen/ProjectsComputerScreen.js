...
import './ProjectsComputerScreen.css';
...
function ProjectsComputerScreen() {
  ...
  function renderProjects() {
    return projects.map((project, index) => {
      return (
        <div key={index} className="computer-project-img">
  ...
  return (
    <Responsive {...Responsive.onlyComputer}>
      <div className="computer-projects-container">
        {renderProjects()}
      </div>
    </Responsive>
  )
...
export default ProjectsComputerScreen
