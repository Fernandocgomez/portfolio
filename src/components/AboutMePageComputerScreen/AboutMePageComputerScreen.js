...
import './AboutMePageComputerScreen.css';
import { Responsive } from "semantic-ui-react";
import img from '../../assets/profile-picture.jpg'

function AboutMePageComputerScreen() {
  return (
    <Responsive {...Responsive.onlyComputer}>
      <div className="computer-screen-about-container">
        <div className="computer-screen-about-img">
          <img src={img} alt=""/>
        </div>

        <div className="computer-screen-about-bio">
          <div className="computer-screen-about-text">
            <h1>About Me!</h1>
...
export default AboutMePageComputerScreen
