...
import './AboutMePageTabletScreen.css';
import { Responsive } from "semantic-ui-react";
import img from '../../assets/profile-picture.jpg'

function AboutMePageTabletScreen() {
  return (
    <Responsive {...Responsive.onlyTablet}>
      <div className="tablet-screen-about-container">
        <div className="tablet-screen-about-img">
          <img src={img} alt=""/>
        </div>

        <div className="tablet-screen-about-bio">
          <div className="tablet-screen-about-text">
            <h1>About Me!</h1>
...
export default AboutMePageTabletScreen
