...
import './ProjectsTabletScreen.css';
...
function ProjectsTabletScreen() {
  ...
  function renderProjects() {
    return projects.map((project, index) => {
      return (
        <div key={index} className="tablet-project-img">
  ...
  return (
    <Responsive {...Responsive.onlyTablet}>
      <div className="tablet-projects-container">
        {renderProjects()}
      </div>
    </Responsive>
  )
...
export default ProjectsTabletScreen
